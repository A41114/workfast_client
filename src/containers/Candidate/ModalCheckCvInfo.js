...
import './ModalCheckCvInfo.scss'

class ModalCheckCvInfo extends Component {
    ...
    render() {
        ...
        return (
            ...
            <ModalFooter>
                <Button color="primary" className='px-3' onClick={()=>this.handleEditFromCheckInfoCvModal()}>Sửa</Button>{' '}
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalCheckCvInfo);
